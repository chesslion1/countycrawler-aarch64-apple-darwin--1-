const TARGET_URL = 'https://foreclosure.broomfield.org/centralrecords/ForeclosureSearch/index.aspx';
...
const navPageElement = {
    id: "#ctl00_ContentPlaceHolder1_gvSearchResults > tbody > tr:nth-child(1) > td > table",
    type: 'a.py-1.px-3',
    value: 'table',
};
const tableElement = {
...
export const broomfieldCountyCrawler = {
